...
Creating a device profile capturing these common set of device attributes, would allow you to create such a template that can be used to create multiple instances of such a device.
