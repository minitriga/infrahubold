...
We will be assuming the following schema has been loaded into Infrahub, this is a requirement to be able to complete ther rest of this guide.
...
From this schema Infrahub will generate a `ProfileInfraInterface` schema. Infrahub will also generate a GraphQL query `ProfileInfraInterface` and the GaphQL mutations `ProfileInfraInterfaceCreate`, `ProfileInfraInterfaceDelete`, `ProfileInfraInterfaceUpdate` and `ProfileInfraInterfaceUpsert`.
...
mutation {
  int0: InfraInterfaceCreate(
    data: {name: {value: "GigabitEthernet0/0/0"}, profiles: [{id: "17c7a464-0482-381b-3137-c513ffc68c84"}]}
  ) {
    ok
    object {
      id
  ...
  int1: InfraInterfaceCreate(
    data: {name: {value: "GigabitEthernet0/0/1"}, profiles: [{id: "17c7a464-0482-381b-3137-c513ffc68c84"}]}
  ) {
    ok
    object {
      id
  ...
  int2: InfraInterfaceCreate(
    data: {name: {value: "GigabitEthernet0/0/2"}, profiles: [{id: "17c7a464-0482-381b-3137-c513ffc68c84"}]}
  ) {
    ok
    object {
      id
  ...
  int3: InfraInterfaceCreate(
    data: {name: {value: "GigabitEthernet0/0/3"}, profiles: [{id: "17c7a464-0482-381b-3137-c513ffc68c84"}]}
  ) {
    ok
    object {
      id
